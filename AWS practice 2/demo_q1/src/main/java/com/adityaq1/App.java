...
public class App {
    private static final String SOURCEPATH="C:\\Users\\adityap16\\Desktop\\AWS P2\\demo_q1\\src\\main\\resources\\sources";
    private static final String DESTPATH="C:\\Users\\adityap16\\Desktop\\AWS P2\\demo_q1\\src\\main\\resources\\desti";
    private static final String BUCKET_NAME="aditya61";
    ...
    public static void upload(S3Client client, String key){
        Path path = Path.of(SOURCEPATH, key);
