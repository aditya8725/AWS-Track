...
public class App {
    private static final String SOURCEPATH="C:\\Users\\adityap16\\Desktop\\AWS practice\\demo_q1\\src\\main\\resources\\source";
    private static final String DESTPATH="C:\\Users\\adityap16\\Desktop\\AWS practice\\demo_q1\\src\\main\\resources\\desti";
    private static final String BUCKET_NAME="mybuc1ket";
    public static void main(String[] args) {
        
        S3Client client = S3Client.builder().region(Region.US_EAST_2).build();
        upload(client, "testdoc.txt");
